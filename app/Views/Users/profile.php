                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center">
                        <div class="dropdown-image">
                            <a class="d-flex flex-column justify-content-end position-relative overflow-hidden rounded-circle bg-size-cover bg-position-center flex-shrink-0" href="#" data-bs-toggle="dropdown-image" aria-expanded="false" style="width: 80px; height: 80px; background-image: url(assets/around/assets/img/avatar/02.jpg);" aria-label="Upload picture">
